      ...
      <div class="flex items-center justify-between bg-white rounded-lg shadow-md p-8">
          ...
          <div class="border-2 border-gray-300 p-8 w-96 rounded-lg">
              ...
              <form class="flex flex-col" on:submit|preventDefault={login}>
                  <input type="email" bind:value={email} placeholder="Email" required class="mb-4 p-2 border border-gray-300 rounded-lg text-base">
                  <input type="password" bind:value={password} placeholder="Mật khẩu" required class="mb-4 p-2 border border-gray-300 rounded-lg text-base">
