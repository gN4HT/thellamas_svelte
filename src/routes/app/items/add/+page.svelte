    ...
    <div class="flex flex-col items-start">
        ...
        <div class="w-full bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mt-8">
                ...
                <a href="#"
                   class="w-full block border border-gray-300 rounded-lg p-3 text-sm text-gray-700 focus:ring-2 focus:ring-blue-500 text-center">THÊM
                    QR / MÃ VẠCH</a>
            ...
            <div class="mt-8">
                ...
                <a href="#"
                   class="w-full block border border-gray-300 rounded-lg p-3 text-sm text-gray-700 focus:ring-2 focus:ring-blue-500 text-center">+
                    Thêm trường mới</a>
                <a href="#"
                   class="w-full block border border-gray-300 rounded-lg p-3 text-sm text-gray-700 mt-3 focus:ring-2 focus:ring-blue-500 text-center">Quản
                    lý trường tùy chỉnh</a>
                <div class="mt-4">
