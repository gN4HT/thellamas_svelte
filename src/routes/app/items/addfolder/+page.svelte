<div class="container mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-2 gap-8">
      ...
      <div>
        ...
        <!-- QR / Barcodes -->
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">QR / Mã vạch</label>
          <a href="#" class="block w-full border border-gray-300 rounded-lg p-3 text-sm text-gray-700 text-center focus:ring-2 focus:ring-blue-500">
            <svg class="w-5 h-5 inline-block mr-2 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- Trường tùy chỉnh -->
        <div>
          <label class="block text-sm font-medium mb-1">TRƯỜNG TÙY CHỈNH</label>
          <div class="space-y-3">
            <a href="#" class="block w-full border border-gray-300 rounded-lg p-3 text-sm text-gray-700 text-center focus:ring-2 focus:ring-blue-500">
              + Thêm trường mới
            </a>
